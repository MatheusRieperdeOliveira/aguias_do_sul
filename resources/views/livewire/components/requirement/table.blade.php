...
new class extends Component {
    ...
    {
        return $this->requirementsQuery()->paginate(15);
    }
    ...
    public function delete($requirementId): void
    {
        Requirement::destroy($requirementId);
        $this->resetPage();
    }

    private function requirementsQuery()
    {
        return Requirement::query()->when(
            $this->address,
            fn ($q) => $q->where('title', 'ilike', '%'.$this->address.'%'),
        )->orderBy('title');
    }
};
?>
