...
<div id="modal"
    ...
    <div id="modalContent"
        ...
        <div class="mb-5">
            <h1 class="text-3xl font-bold text-foreground">Novo desbravador</h1>
        ...
        <form method="POST" action="{{ route('pathfinder.store') }}">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <label>Telefone
                    <input type="text" name="full_phone" placeholder="Telefone"
                           class="w-full border rounded p-2 mb-3">
                </label>

                <label>Data de aniversário
                    <input type="date" name="birthday" placeholder="Data de aniversário"
                           class="w-full border rounded p-2 mb-3">
                </label>
